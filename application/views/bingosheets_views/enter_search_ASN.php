...
<?php
	...
	echo "<br><br><br>";
	echo form_open('control_bingosheets/searchDataByPNO', 'name="form_ASN_entry"');
	...
	echo "<table><tr><td>";
	echo form_label($this->lang->line('search_ASN'), 'txt_ASN'); //convert to datetime
	$data = array('name' => 'txt_ASN','id' => 'txt_ASN','value' => '','maxlength' => '8','size' => '7');
	echo "</td><td>";
